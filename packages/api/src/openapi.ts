...
export const openApiSpec = {
  ...
  info: {
    title: 'Cullit API',
    version: '0.1.0',
    description: 'AI-powered release notes generation. Supports Anthropic Claude, OpenAI, Gemini, Ollama, and OpenClaw.',
    contact: {
      name: 'Deploy or Die',
      url: 'https://cullit.io',
    ...
    schemas: {
      GenerateRequest: {
        ...
        properties: {
          ...
          provider: {
            type: 'string',
            enum: ['anthropic', 'openai', 'gemini', 'ollama', 'openclaw'],
            default: 'anthropic',
          },
          model: {
            type: 'string',
