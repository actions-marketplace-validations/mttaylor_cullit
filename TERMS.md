...
Cullit is an open-source project with optional hosted components. Usage is governed by these Terms and the [LICENSE](LICENSE) file.

## 2. License

Cullit source code is provided under the [LICENSE](LICENSE) file.

## 3. Account and Access

When using hosted features (for example dashboard login and team workflows), you are responsible for:
...
Cullit is funded by optional donations and GitHub Sponsors support.

- Sponsorship is optional and does not unlock paid tiers or restricted features
- Donations are voluntary support for project maintenance
